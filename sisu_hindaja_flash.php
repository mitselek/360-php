...
/**/    $mark = "<a name=\"#mark$kys_num\"></a>";
   ...
   if( ( $vastused_a[$kys_num][vastus] >= 0 ) AND ( $vastused_a[$kys_num] ) )
    ...
    $loc = "";
   $ret_str .= "    <tr><td colspan=\"2\"><img src=\"./_img/minus.gif\" width=\"18\" height=\"18\" alt=\"minus\"><input type=\"image\" title=\"vastan\" src=\"_img/?w=690&h=18&c1=ffaaaa&c2=aaffaa$loc\" width=\"690\" height=\"18\" name=\"pidev\"><img src=\"./_img/plus.gif\" width=\"18\" height=\"18\" alt=\"plus\"></td></tr>\n";
...
//    <input type="image" src="_img/?w=721&h=12&c1=ffaaaa&c2=aaffaa&loc=585" width="721" height="12" name="k!12">
